...
Ship* Field::removeUnit(const UnitType unitType, const std::string &sPosition)
{
    Ship* result = nullptr;
...
Ship* Field::removeUnit(const UnitType unitType, const Coordinate position)
{
    Ship* result = nullptr;
...
Coordinate Field::string_to_Coordinate(const std::string sPosition)
{
    Coordinate result;
